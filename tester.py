...
parser = argparse.ArgumentParser(
    description='This is an algorithm testing script')
...
parser.add_argument("-l", "--language",
                    help="Programming language of the algorithm")

args = parser.parse_args()

result, stats = CheckerController.main_check(
    tested_file=args.algo, results_file=args.results, tests_file=args.tests, language=args.language)
